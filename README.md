...
### 1.4. OPTIONAL: Groups and High resolution links
...
### 1.5. Contribute to Existing Themes
...
The pins you will upload to Pin Library need to be configured in EO Browser. If you don't know how to use EO Browser, check out [this tutorial](https://www.sentinel-hub.com/explore/eobrowser/).
